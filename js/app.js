(() => {
    ...
    function initSliders() {
        if (document.querySelector(".slider-what__slider")) new core(".slider-what__slider", {
            modules: [ Pagination ],
            observer: true,
            observeParents: true,
            autoHeight: true,
    ...
    window.onload = function() {
        ...
        function documentActions(e) {
            ...
            if (targetElement.classList.contains("search-header__button")) document.querySelector(".search-header__form").classList.toggle("_active"); else if (!targetElement.closest(".search-header__form") && document.querySelector(".search-header__form._active")) document.querySelector(".search-header__form").classList.remove("_active");
            if (targetElement.classList.contains("top-header__close")) document.querySelector(".header").classList.toggle("_close");
            if (targetElement.classList.contains("top-header__close")) document.querySelector(".main-block").classList.toggle("_close");
        }
    };
    window["FLS"] = true;
    isWebp();
